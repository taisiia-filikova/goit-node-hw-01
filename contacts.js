...
async function listContacts() {
  try {
    ...
    console.log('List of contacts:'.red);
...
async function getContactById(contactId) {
  try {
    ...
    console.log(`Contact with ID ${contactId}:`.red);
...
async function removeContact(contactId) {
  try {
    ...
    console.log('Contact deleted successfully! New list of contacts:'.red);
...
async function addContact(name, email, phone) {
  try {
    ...
    console.log('Contact added successfully! New list of contacts:'.red);
    console.table(newContacts);
